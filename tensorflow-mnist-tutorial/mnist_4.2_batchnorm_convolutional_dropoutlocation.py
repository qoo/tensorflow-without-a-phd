...
def training_step(i, update_test_data, update_train_data):
    ...
    tt, a, c, im, ca, da, l=sess.run([train_step, accuracy, cross_entropy, I, conv_activations, dense_activations, lr], {X: batch_X, Y_: batch_Y, tst: False, iter: i, pkeep: 0.75, pkeep_conv: 1.0})
    print(str(i) + ": accuracy:" + str(a) + " loss: " + str(c) + " (lr:" + str(l) + ")")
    # datavis.append_training_curves_data(i, a, c)
    # datavis.update_image1(im)
    # datavis.append_data_histograms(i, ca, da)
